...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/min/sources/menu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/min/sources/mini.jpg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/min/sources/641811830ab31eca1fb5d5f18fab69ab.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/min/sources/quit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        for i, o in zip(D, range(len(D))):
            item_1 = QtWidgets.QTreeWidgetItem(item_0)
            self.treeWidget.topLevelItem(0).child(o).setText(0, _translate("MainWindow", D[o]))
            B = get_kanasakusya(D[o])
            for j, k in zip(B, range(len(B))):
                item_2 = QtWidgets.QTreeWidgetItem(item_1)
                self.treeWidget.topLevelItem(0).child(o).child(k).setText(0, _translate("MainWindow", B[k][2]))
        item_0 = QtWidgets.QTreeWidgetItem(self.treeWidget)
        #item_1 = QtWidgets.QTreeWidgetItem(item_0)
        #item_2 = QtWidgets.QTreeWidgetItem(item_1)m_1)
        #item_2 = QtWidgets.QTreeWidgetItem(item_1)
        #item_2 = QtWidgets.QTreeWidgetItem(ite
        #self.treeWidget.topLevelItem(1).child(0).setText(0, _translate("MainWindow", "あ"))
        #self.treeWidget.topLevelItem(1).child(0).child(0).setText(0, _translate("MainWindow", "あほ"))
        #self.treeWidget.topLevelItem(1).child(0).child(1).setText(0, _translate("MainWindow", "New Item"))
        #self.treeWidget.topLevelItem(1).child(0).child(2).setText(0, _translate("MainWindow", "New Item"))
        #self.treeWidget.topLevelItem(1).child(1).setText(0, _translate("MainWindow", "い"))
        C = get_sakuhinnCa()
        for i, o in zip(C, range(len(C))):
            item_1 = QtWidgets.QTreeWidgetItem(item_0)
            self.treeWidget.topLevelItem(1).child(o).setText(0, _translate("MainWindow", C[o]))
            A = get_kanasakuhinn(C[o])
            for j, k in zip(A, range(len(A))):
                item_2 = QtWidgets.QTreeWidgetItem(item_1)
                self.treeWidget.topLevelItem(1).child(o).child(k).setText(0, _translate("MainWindow", A[k][2]))
        self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "作者序"))
        self.treeWidget.topLevelItem(1).setText(0, _translate("MainWindow", "作品序"))
        ...
        self.max_button.clicked.connect(MainWindow.showFullScreen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/logo/sources/logo2.png\"/></p></body></html>"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\">青空文庫読取り</p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt;\">AOZORABUNNKO</span></p></body></html>"))
        self.treeWidget.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>ｗっくぇ</p></body></html>"))
        self.treeWidget.headerItem().setText(0, _translate("MainWindow", "排序"))
        __sortingEnabled = self.treeWidget.isSortingEnabled()
        self.treeWidget.setSortingEnabled(False)
        #self.treeWidget.topLevelItem(0).setText(0, _translate("MainWindow", "作者序"))
        #self.treeWidget.topLevelItem(0).child(0).setText(0, _translate("MainWindow", "あ"))
        #self.treeWidget.topLevelItem(0).child(0).child(0).setText(0, _translate("MainWindow", "あつかっきあつかっき"))
        #self.treeWidget.topLevelItem(0).child(0).child(1).setText(0, _translate("MainWindow", "New Item"))
        #self.treeWidget.topLevelItem(0).child(0).child(2).setText(0, _translate("MainWindow", "New Item"))
        #self.treeWidget.topLevelItem(0).child(0).child(3).setText(0, _translate("MainWindow", "New Item"))
        #self.treeWidget.topLevelItem(0).child(1).setText(0, _translate("MainWindow", "い"))
        #self.treeWidget.topLevelItem(1).setText(0, _translate("MainWindow", "作品序"))
        #self.treeWidget.topLevelItem(1).child(0).setText(0, _translate("MainWindow", "あ"))
        #self.treeWidget.topLevelItem(1).child(0).child(0).setText(0, _translate("MainWindow", "あほ"))
        #self.treeWidget.topLevelItem(1).child(0).child(1).setText(0, _translate("MainWindow", "New Item"))
        ...
        self.button_seek.setText(_translate("MainWindow", "搜索"))
